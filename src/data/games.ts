...
export const gamesData: Game[] = [
  {
    ...
    slug: 'ludo-hero',
    description:
      'Ludo Hero is the best multiplayer board game where you play with more than two players online on Poki. This is the best classic game because the origin from the German board game, In this game, you will see a different game with few colours. There are different pieces and challenges where you have to play with your friends and opponents. You will enjoy this game by inviting your friends from all over the world. Each player has one color to play at one time. You will win when all your pieces enter into the passage and then first house.',
    image: '/images/placeholder.svg',
    iframeUrl: 'https://html5.poki.com/en/g/ludo-hero/',
    category: 'Board Games',
    rating: 4.5,
    meta: {
      title: 'Ludo Hero - Play Free Online | Poki',
      description:
  ...
  },
  {
    ...
    rating: 4.2,
    meta: {
      title: 'Stickman War - Play Free Online | Poki',
